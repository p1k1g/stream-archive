...
try {
    ...
    Assert-Match $gitignore '(?m)^rust-runtime/target/\r?    Assert-NotMatch $gitignore '(?m)^rust-web/target/\r?$' 'Git ignore must not retain the retired rust-web Cargo target directory.'
