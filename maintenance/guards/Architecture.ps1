...
Assert-Match $maintenanceUi '(?:Diagnostics.*read-only|진단.*읽기\s*전용)' 'Read-only diagnostics must live in the nested Settings management view.'
...
Assert-NotMatch $guiUi '백업 정책' 'General settings must not duplicate backup policy presentation.'
