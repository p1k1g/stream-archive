...
Assert-Match $maintenanceUi 'Phase 21\.9: Settings > Manage diagnostics are read-only\.' 'Read-only diagnostics must live in the nested Settings management view.'
